...
class InterpreterTest {
    ...
    void setToZeroTest() throws IOException {
        ...
        controller.interpreter(getCode("1.bf"),false);
    ...
    void assignmentTest() throws IOException {
        ...
        model.setVal(0, '5');
        model.setVal(1, '9');
        controller.interpreter(getCode("2.bf"),false);
    ...
    void sumTest() throws IOException {
        ...
        controller.interpreter(getCode("3.bf"),false);
    ...
    void subtractionTest() throws IOException {
        ...
        controller.interpreter(getCode("4.bf"),false);
    ...
    void multiplicationTest() throws IOException {
        ...
        controller.interpreter(getCode("5.bf"),false);
    ...
    void squareTest() throws IOException {
        ...
        controller.interpreter(getCode("6.bf"),false);
    ...
    void divisionTest() throws IOException {
        ...
        controller.interpreter(getCode("7.bf"),false);
    ...
    void toAPowerTest() throws IOException {
        Model model = new Model(16);
        Controller controller = new Controller(model, new View());
        controller.interpreter(getCode("8.bf"),false);
    ...
    void swapTest() throws IOException {
        ...
        controller.interpreter(getCode("9.bf"),false);
